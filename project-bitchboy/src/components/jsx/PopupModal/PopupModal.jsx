  ...
  return (
    <>
      ...
      <div className={`modal-overlay ${className} `}>
        <div className="absolute mt-25 flex flex-col p-20 bg-black border-2 border-green-400 rounded-lg shadow-lg overflow-hidden z-3">
          {/* Close button */}
          <div>
            <span
          ...
          <label className="mb-3 text-green-400 text-sm tracking-wider flex items-center justify-center">
            <span className="text-green-400 font-bold text-6xl animate-pulse">
              JOIN US
            </span>
          </label>
          <label className="mb-3 text-green-400 text-sm tracking-wider flex items-center justify-center">
            <span className="text-green-300 text-lg mt-2">
          ...
          <div className="tracking-wider flex items-center justify-center">
            <button className="outer-btn mt-10" onClick={handleSubmit}>
